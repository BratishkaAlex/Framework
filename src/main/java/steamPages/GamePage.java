...
public class GamePage {
    private By gameNameReserveLoc = By.xpath("(//div[@id='game_area_purchase']//h1)[1]");
    private By gameNameLoc = By.xpath("//div[@class='page_content']//h2[@class='pageheader']");
    ...
    public String getGameName() {
        return new Label(gameNameReserveLoc).getText();
    }
